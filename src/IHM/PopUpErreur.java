 ...
 * @author Linkro
 */
public class PopUpErreur extends javax.swing.JFrame {

    /**
     * Creates new form PopUpErreur
     */
    public PopUpErreur() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tAreaErreur.setText("ERREUR : Le voeu n'a pas été ajouté.\n\nCAUSE : Le voeu que vous souhaitez ajouter \nexiste déjà dans votre liste de voeux");
        tAreaErreur.setSelectionColor(new java.awt.Color(0, 0, 0));
        jScrollPane2.setViewportView(tAreaErreur);

        jButton1.setText("Fermer la pop-up");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpErreur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
